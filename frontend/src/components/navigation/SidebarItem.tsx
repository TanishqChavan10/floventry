  ...
  return (
    ...
    >
      ...
      <div className={cn(
         ...
         isActive ? "bg-indigo-100/50 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400" : "bg-transparent"
      )}>
        <Icon
          className={cn(
      ...
      <motion.span
        ...
        className={cn(
          'text-[0.925rem] font-medium whitespace-nowrap tracking-tight',
        )}
      >
        {label}
      </motion.span>
