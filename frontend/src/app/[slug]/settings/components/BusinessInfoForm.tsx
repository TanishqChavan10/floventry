...
export function BusinessInfoForm({ company, settings }: BusinessInfoFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      // Split updates between Company and CompanySettings
      const companyInput = {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Address, tax details, and regional settings.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
