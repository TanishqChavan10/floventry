...
function InventoryHealthTab() {
  ...
  const healthChartData = healthData?.inventoryHealthStats
    ? [
        ...
        {
          name: 'Warning',
          value: healthData.inventoryHealthStats.warningCount,
          fill: COLORS.warning,
        },
        {
          name: 'Critical',
          value: healthData.inventoryHealthStats.criticalCount,
        ...
        {loading ? (
          ...
          <ChartContainer config={chartConfig} className="h-[300px] w-full">
            <BarChart accessibilityLayer data={scorecardData?.warehouseHealthScorecard || []}>
              ...
              <Bar dataKey="okCount" stackId="a" fill={COLORS.in} radius={[0, 0, 4, 4]} />
              <Bar dataKey="warningCount" stackId="a" fill={COLORS.warning} radius={[0, 0, 0, 0]} />
              <Bar
